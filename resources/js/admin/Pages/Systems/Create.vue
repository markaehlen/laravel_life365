<template>
  <div id="roles">
    <div class="w-full border-b block 2xl:flex xl:flex lg:flex md:flex flex-nowrap justify-between items-center bg-gray-50 p-5 mb-5">
      <h1 class="font-semibold text-2xl">Add Unit System</h1>
      <div class="flex">
        <!-- breadcrumb -->
        <nav class="text-sm font-semibold" aria-label="Breadcrumb">
          <ol class="list-none inline-flex">
            ...
            <li class="flex items-center text-indigo-500">
              <inertia-link :href="route('admin.systems.index')" class="text-gray-700"> Unit System </inertia-link>
              <icon name="cheveron-right" class="fill-current w-4 h-4 mx-2 mt-1" />
            </li>
...
export default {
  metaInfo: { title: "Add Unit System" },
  components: {
    Icon,
    TextInput,
    ActionBack,
  ...
  methods: {
    store() {
      this.form.post(this.route('admin.unit-systems.store'))
    },
  },
}
</script>

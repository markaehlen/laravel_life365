<template>
  <div id="faqs">
    ...
    <div class="w-full border-b block 2xl:flex xl:flex lg:flex md:flex flex-nowrap justify-between items-center bg-gray-50 p-5 mb-5">
      <h1 class="font-semibold text-2xl">Edit Economic Parameter</h1>
      <div class="flex">
        <!-- breadcrumb -->
...
export default {
  ...
  methods: {
    update() {
      this.form.post(this.route('admin.ecoparameters.update', this.ecoparameter.id), {

  ...
  <div class="p-6 bg-indigo-800 min-h-screen flex justify-center items-center">
    <div class="w-full max-w-md">
      ...
      <form class="mt-8 bg-white shadow-xl overflow-hidden" @submit.prevent="login">
        <div class="px-10 py-5 inst-login-block">
          <h1 class="text-center">
            <logo class="life-logo" />
          </h1>
          <div class="mx-auto mt-5 w-24" />
        ...
        <div class="px-10 py-4 bg-gray-100 border-t border-gray-100 flex justify-between items-center inst-login-block">
          ...
          <loading-button :loading="form.processing" class="btn-indigo" type="submit" style="border-radius: 0px">Login</loading-button>
        </div>
      </form>
    </div>
  </div>

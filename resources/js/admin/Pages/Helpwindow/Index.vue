        ...
        <nav class="text-sm font-semibold" aria-label="Breadcrumb">
          <ol class="list-none p-0 inline-flex">
            ...
            <li class="flex items-center">
              <a href="javascript:void" class="text-gray-600">Help Windows</a>
            </li>
          </ol>
        </nav>
        <!-- breadcrumb end -->
          ...
          <tr v-for="page in pages.data" :key="page.id" class="border-b border-gray-200 hover:bg-gray-100">
            ...
            <td class="py-3 px-6">
              <div class="flex item-center justify-center">
                <action-preview :href="route('admin.helpwindows.show', page.id)" title="View" />
                <action-edit :href="route('admin.helpwindows.edit', page.id)" title="Edit" />
              </div>
            </td>
          </tr>
...
export default {
  metaInfo: { title: 'Helping Windows' },
  components: {
    Icon,
    Sortable,
    Pagination,
  ...
  watch: {
    form: {
      handler: throttle(function () {
        ...
        this.$inertia.replace(this.route('admin.helpwindows.index', query))
      }, 150),
      deep: true,
    },
  },

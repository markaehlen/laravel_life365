<template>
  <div id="locations">
    <div class="w-full border-b block 2xl:flex xl:flex lg:flex md:flex flex-nowrap justify-between items-center bg-gray-50 p-5 mb-5">
      <h1 class="font-semibold text-2xl">Add Sub-Location</h1>
      <div class="flex">
        <!-- breadcrumb -->
    ...
    <div class="bg-white">
      <form @submit.prevent="store">
        ...
        <div class="p-5 -mr-5 -mb-2 flex flex-wrap">
          <number-input v-model="form.jan_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.jan_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="January" />
          <number-input v-model="form.feb_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.feb_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="February" />
          <number-input v-model="form.mar_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.mar_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="March" />
          <number-input v-model="form.apr_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.apr_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="April" />
          <number-input v-model="form.may_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.may_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="May" />
          <number-input v-model="form.jun_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.jun_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="June" />
          <number-input v-model="form.jul_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.jul_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="July" />
          <number-input v-model="form.aug_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.aug_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="August" />
          <number-input v-model="form.sep_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.sep_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="September" />
          <number-input v-model="form.oct_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.oct_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="October" />
          <number-input v-model="form.nov_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.nov_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="November" />
          <number-input v-model="form.dec_temp" :min="-45.6" :max="65.6" :step="'any'" :error="form.errors.dec_temp" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="December" />
        </div>
        <div class="p-5 -mr-5 -mb-2 flex flex-wrap">
        ...
        <div class="p-5 -mr-5 -mb-2 flex flex-wrap">
          ...
          <number-input v-model="form.snow_day" :min="1" :max="365" :step="'1'" :error="form.errors.snow_day" :required="true" class="pr-5 pb-2 w-full lg:w-1/4" label="Snow Days" />
...
export default {
  metaInfo: { title: 'Add Sub-location' },
  components: {
    Icon,
    TextInput,
    SelectInput,
  ...
  methods: {
    store() {
      this.form.post(this.route('admin.sublocations.store'))
    },
  },
}
</script>

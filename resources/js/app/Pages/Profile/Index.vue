        ...
        <nav class="text-sm font-semibold" aria-label="Breadcrumb">
          <ol class="list-none p-0 inline-flex">
            <li class="flex items-center text-indigo-500">
              <inertia-link :href="route('dashboard')" class="text-gray-700">
                Home
              </inertia-link>
    ...
    <div class="bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="update">
        <div class="p-5 -mr-5 -mb-2 flex flex-wrap">
          <text-input v-model="form.first_name" :error="form.errors.first_name" :required="true" class="pr-5 pb-2 w-full lg:w-1/3" label="First name" />
          <text-input v-model="form.last_name" :error="form.errors.last_name" :required="true" class="pr-5 pb-2 w-full lg:w-1/3" label="Last name" />
          <text-input v-model="form.email" :error="form.errors.email" :required="true" class="pr-5 pb-2 w-full lg:w-1/3" label="Email"/>
          <!-- <text-input v-model="form.phone" :error="form.errors.phone" :required="true" class="pr-5 pb-2 w-full lg:w-1/2" type="text" label="Phone" /> -->
          <!-- <text-input v-model="form.role" :error="form.errors.role" :required="true" class="pr-5 pb-2 w-full lg:w-1/2" type="text" label="Role" readonly disabled /> -->

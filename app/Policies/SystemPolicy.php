...
class SystemPolicy
{
    ...
    public function viewAny(Admin $user)
    {
        return $user->hasModulePermission(
            config('authorization.MODULES.SYSTEM'),
            [
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(Admin $user, System $system = null)
    {
        return $user->hasModulePermission(
            config('authorization.MODULES.SYSTEM'),
            [
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(Admin $user, System $system = null)
    {
        return $user->hasModulePermission(
            config('authorization.MODULES.SYSTEM'),
            [
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(Admin $user, System $system = null)
    {
        return $user->hasModulePermission(
            config('authorization.MODULES.SYSTEM'),
            [
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(Admin $user, System $system = null)
    {
        return $user->hasModulePermission(
            config('authorization.MODULES.SYSTEM'),
            [

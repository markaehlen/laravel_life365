...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // Create modules
        factory(Module::class)->create(['name' => 'Users']);
        factory(Module::class)->create(['name' => 'Roles']);
        factory(Module::class)->create(['name' => 'Faqs']);
        factory(Module::class)->create(['name' => 'Pages']);
        factory(Module::class)->create(['name' => 'Settings']);
        factory(Module::class)->create(['name' => 'Enquiries']);
        factory(Module::class)->create(['name' => 'Email Templates']);
        factory(Module::class)->create(['name' => 'Testimonials']);

        // Create roles
        factory(Role::class)->create(['name' => 'Admin', 'is_system' => true]);
        factory(Role::class)->create(['name' => 'User', 'is_system' => true]);

        // Create permission
        factory(Permission::class)->create(['name' => 'None']);
        factory(Permission::class)->create(['name' => 'Full']);
        factory(Permission::class)->create(['name' => 'Writer']);
        factory(Permission::class)->create(['name' => 'Editor']);
        factory(Permission::class)->create(['name' => 'Read-only']);
        ...
        factory(EmailTemplate::class)->create([
            ...
            'class' => '\App\Mails\Admin\ResetPassword'
        ]);
        ...
        factory(EmailTemplate::class)->create([
            ...
            'model' => '\App\Models\User',
            'class' => '\App\Mails\Admin\PasswordChanged'
        ]);
        ...
        factory(EmailTemplate::class)->create([
            ...
            'model' => '\App\Models\User',
            'class' => '\App\Mails\Admin\NewUserRegistered'
        ]);
        ...
        factory(EmailTemplate::class)->create([
            ...
            'model' => '\App\Models\User',
            'class' => '\App\Mails\Admin\AccountActivated'
        ]);
        ...
        factory(EmailTemplate::class)->create([
            ...
            'model' => '\App\Models\User',
            'class' => '\App\Mails\Admin\AccountDeActivated'
        ]);
